...
type MailServiceClient interface {
	Send(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *mailServiceClient) Send(ctx context.Context, in *SendMailRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/mail.MailService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MailServiceServer interface {
	Send(context.Context, *SendMailRequest) (*emptypb.Empty, error)
...
func (UnimplementedMailServiceServer) Send(context.Context, *SendMailRequest) (*emptypb.Empty, error) {
...
var MailService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/mail/mail.proto",
}
